...
- `server/uploads.ts` — attachment intake: base64 in, files under `uploads/` and small URLs in the transcript, region crops expanded into extra model-visible images.
